...
namespace App\Http\Livewire\BallotsSelect;
...
class BallotsSelect extends Component
{
    public $query;
    ...
    public function updatedQuery()
    {
        $this->closed = false;
            ...
            $this->functions = BallotItem::where('service_station_id',  $this->serviceStationId)->get()
            ->toArray();
    ...
    {
        return view('livewire.ballotsSelect.ballots-select');
    }
