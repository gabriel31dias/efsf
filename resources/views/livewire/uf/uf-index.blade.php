    ...
    <div class="col-12 col-md-auto ms-auto d-print-none">
       <div class="btn-list">
         @can('permission', 'locale.create')
            <a wire:click="addUf" class="btn btn-primary items-center inline-flex" data-bs-toggle="modal"
                ...
                <div id="table-default" class="table-responsive">
                   <table class="table">
                      ...
                      <tbody class="table-tbody">
                         @foreach ($ufs as $uf)
                         <tr  @can('permission', 'locale.edit') wire:click="clickUpdate({{$uf->id}}) @endcan">
                            <td>{{ $uf->name }}</td>
                            <td>{{ $uf->acronym }}</td>
