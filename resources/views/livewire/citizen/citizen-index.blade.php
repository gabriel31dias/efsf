       ...
       <div class="col-md-12">
          <div>
             <ul class="nav nav-tabs" data-bs-toggle="tabs" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                    <a wire:click="setSelectedTab('nome_social')" class="nav-link" data-bs-toggle="tab" aria-selected="false"
                    class="nav-link @if($selectedTab == "nome_social") active @else   @endif"
                    role="tab" tabindex="-1">Nome Social</a>
                </li>
                <li class="nav-item" role="presentation">
                    <a wire:click="setSelectedTab('gemeo')" class="nav-link" data-bs-toggle="tab" aria-selected="false"
                    class="nav-link @if($selectedTab == "gemeo") active @else   @endif"
                    role="tab" tabindex="-1">Gemeo</a>
                </li>
