          ...
          <div >
             <ul class="nav nav-tabs" data-bs-toggle="tabs" role="tablist">
                <li class="nav-item" role="presentation">
                   <a href="#dados-basicos" class="nav-link active" data-bs-toggle="tab" aria-selected="true" role="tab">Dados Basicos</a>
                </li>
                <li class="nav-item" role="presentation">
                   <a href="#endereco" class="nav-link" data-bs-toggle="tab" aria-selected="false" role="tab" tabindex="-1">Endereço</a>
                </li>
                <li class="nav-item" role="presentation">
                   <a href="#tabs-profile-7" class="nav-link" data-bs-toggle="tab" aria-selected="false" role="tab" tabindex="-1">Certidão</a>
                </li>
             </ul>
             <div class="card-body">
                <div class="tab-content">
                   <div class="tab-pane active show" id="dados-basicos" role="tabpanel">
                      <div class="page-body">
                         <div class="container-fluid">
                            <div class="modal-content">
                               <div class="modal-body">
                                  <div class="row">
                                     ...
                                     <div class="container-fluid ">
                                        ...
                                        <div class="row">
                                           ...
                                           <div class="row">
                                              ...
                                              <div class="col-lg-6">
                                                 <div class="mb-3">
                                                    <label class="form-label">{{$item}} {{$index }}</span></label>
                                                    <div class="input-group input-group-flat">
                                                       <input wire:model="otherFiliationsValues.{{$index}}"  maxlength="11"  type="text" class="form-control ps-0"  autocomplete="off" required>
                                                    </div>
                                                 </div>
                                              </div>
                                              @endforeach
                                     ...
                                     <div class="col-lg-2">
                                        <div class="mb-3">
                                           <label class="form-label">Data de Nascimento<span class="error_tag">*</span></label>
                                           <div class="input-group input-group-flat">
                                              ...
                                              <div class="modal-body">
                                                 <div class="row" >
                                                    <div  class="col-lg-6 mb-3">
                                                       ...
                                                       <input  onclick="IMask(
                                                          this, {
                                                          mask: '000.000.000-00'
                                                          });" wire:model="searchCpf" placeholder="Cpf do cidadão" type="text" class="form-control cpf" name="example-text-input" placeholder="Busque por Nome, Rg, Genero, Data de nascimento, Filiação">
                                                    </div>
                                                    <div class="col-lg-6 mb-3">
                                                 ...
                                                 <div class="row" >
                                                    ...
                                                    <div class="col-lg-6 mb-3">
                                                       ...
                                                       <div class="input-group input-group-flat">
                                                          <select wire:model="searchGenrer" class="form-control ps-0"  name="select">
                                                 ...
                                                 <div class="row" >
                                                    <div class="col-lg-6 mb-3">
                                                       ...
                                                       <input id="nsc" onclick="IMask(
                                                          this, {
                                                          mask: '00/00/0000'
                                                          });" wire:model="searchBirth" placeholder="Data nascimento" type="text" class="form-control date" name="example-text-input" placeholder="Busque por Nome, Rg, Genero, Data de nascimento, Filiação">
                                                    </div>
                                                    <div class="col-lg-6 mb-3">
                         ...
                         <div class="container-fluid">
                            <div class="row">
                               ...
                               <div class="col-lg-4 mb-3">
                                  ...
                                  <div class="input-group input-group-flat">
                                     <input  maxlength="70" type="text" class="form-control ps-0"  autocomplete="off" required>
                                  </div>
                               </div>
                               <div class="col-lg-4 mb-3">
                               ...
                               <div class="col-lg-4 mb-3">
                                  <label  class="form-label">Procedência<span class="error_tag">*</span></label>
                                  <input  maxlength="70" type="text" class="form-control ps-0"  autocomplete="off" required>
                               </div>
                               <div class="col-lg-4 mb-3">
                                  <label  class="form-label">Ponto de Referência<span class="error_tag">*</span></label>
                                  <input  maxlength="70" type="text" class="form-control ps-0"  autocomplete="off" required>
                               </div>
                               <div class="col-lg-4 mb-3">
                                  <label  class="form-label">Tel. Celular<span class="error_tag">*</span></label>
                                  <input  maxlength="70" type="text" class="form-control ps-0"  autocomplete="off" required>
                               </div>
                               <div class="col-lg-4 mb-3">
                                 <label  class="form-label">Tel. fixo<span class="error_tag">*</span></label>
                                 <input  maxlength="70" type="text" class="form-control ps-0"  autocomplete="off" required>
                               </div>
                               <div class="col-lg-4 mb-3">
