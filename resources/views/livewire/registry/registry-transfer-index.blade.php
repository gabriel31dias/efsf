             ...
             <div class="card-body">
                <div id="table-default" class="table-responsive">
                   <table class="table">
                      <thead>
                         <tr>
                            <th><button class="table-sort" >Origem</button></th>
                            <th><button class="table-sort" >Destino</button></th>
                            <th><button class="table-sort" >Data de Transferência</button></th>
                         </tr>
                      </thead>
                      <tbody class="table-tbody">
                         @foreach ($transfers as $transfer)
                         <tr>
                            <td class="">{{$transfer->origin->name}}</td>
                            <td class="">{{$transfer->destination->name}}</td>
                            <td class="">{{$transfer->created_at->format('d/m/Y')}}</td>
                         </tr>
                         @endforeach
                      </tbody>
                   </table>
