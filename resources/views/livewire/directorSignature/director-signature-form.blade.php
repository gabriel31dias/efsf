                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div  class="col-lg-3">
                            ...
                            <div class="input-group input-group-flat">
                                <input wire:model="cpf" maxlength="70" type="text" class="form-control" autocomplete="off" disabled/>
                            </div>
                        </div>
                        ...
                        <div class="container-fluid card">
                            <div class="col-sm-6 mt-3">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control" wire:model="unit" placeholder="Unidade" aria-label="" aria-describedby="basic-addon2" disabled/>
                                </div>
                            </div>
                            <table class="table">
                                <thead>
                        ...
                        <div wire:ignore style="margin-bottom: 1%" class="container-fluid card col-md-6 col-lg-6">
                            <div >
                              <div class="card-body p-4 text-center">
                                ...
                                <a href="#" class="d-block"><img id="preview-image" style="max-height: 400px; width: 100%" src="@if (isset($directorSign['file_signature'])){{  '/storage/signatures/'.$directorSign['file_signature'] }} @else {{'/pencil.jpg'}}@endif" class="card-img-top"></a>

                              </div>
                              <div class="d-flex">
                                <a id="select-image-button"  class="card-btn btn-primary "><!-- Download SVG icon from http://tabler-icons.io/i/mail -->
