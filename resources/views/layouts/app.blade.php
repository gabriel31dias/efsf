...
<body>
        ...
        <header class="navbar navbar-expand-md navbar-light d-print-none">
            <div class="container-fluid">
                ...
                <h1 class="navbar-brand navbar-brand-autodark d-none-navbar-horizontal pe-0 pe-md-3">
                    <a href=".">
                        <img src="./static/logo.svg" alt="Tabler" class="navbar-brand-image" width="110"
                            height="32">
                    </a>
                </h1>
                <div class="navbar-nav flex-row order-md-last">
                    ...
                    <div class="d-none d-md-flex">
                        ...
                        <div class="nav-item dropdown d-none d-md-flex me-3">
                            <a onclick="setVisualizedItems()" class="nav-link px-0" data-bs-toggle="dropdown"
                            ...
                            <div class="dropdown-menu dropdown-menu-arrow dropdown-menu-end dropdown-menu-card "
                                ...
                                <div class="card">
                                    ...
                                    <div class="list-group list-group-flush list-group-hoverable">
                                        ...
                                        @php
                                            $notifications = (new App\Http\Services\GetNotifications())->call([
                                                'user_id_receive' => Auth::user()->id,
                                                'service_stations' => auth()
                                                    ->user()
                                                    ->userStations->toArray(),
                                            ])['notifications'];
                                        @endphp
                        ...
                        <div class="nav-item dropdown d-none d-md-flex me-3">
                            <a href="#" onclick="Turbolinks.visit('/logout')" class="nav-link px-0"
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div id="options-menu" style="display: "
                            class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                       
                        <a href="#" onclick="Turbolinks.visit('/logout')" class="nav-link px-0" data-bs-toggle="dropdown" tabindex="-1" aria-label="Show notifications">
                                <!-- Download SVG icon from http://tabler-icons.io/i/bell -->
    ...
    <script>
        ...
        window.addEventListener('editPassword', ({
            detail: {
                user
            }
        }) => {
        ...
        window.addEventListener('changed_indicador_social', ({
            detail: {
                user
            }
        }) => {
